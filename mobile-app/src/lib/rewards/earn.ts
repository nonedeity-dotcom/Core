...
export const SPARKS = {
  ...
  weight: 5,
  /**
   * День, в который все экранные привычки удержались.
   *
   * Мера — сами привычки, а не общий лимит из настроек Creker: раньше их было два, и в один
   * можно было уложиться, а в другой нет. Лимит у привычки человек ставит себе сам, и его
   * можно задрать; но прошедший день рассчитывается один раз и записывается в журнал
