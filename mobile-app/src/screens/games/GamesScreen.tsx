  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.intro}>
        Размяться головой, когда голова уже не варит на работу. Ничего не начисляется и никуда
        не уходит — здесь нет ни жизней, ни кристаллов, ни повода заходить каждый день.
      </Text>
