...
его коротким. Планка при этом ваша — в настройках, «Зачёт дня», её можно опустить до
фиксированного числа привычек или до доли от списка. Правило пересчитывает и прошлое:
